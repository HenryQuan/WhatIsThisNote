...
scales such as pentatonic and blues, and build the diatonic chords of the key
with Roman numerals, inversions and simple progressions.
...
- `lib/core` - music theory (notes, clefs, keys, scales, chords) and staff
  geometry
- `lib/ui/painters` - the `CustomPainter` that draws the staff, clef, key
  signature, ledger lines, note and chord
